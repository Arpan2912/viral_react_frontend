...
class LotHistory extends Component {
    ...
    closeUpdateLotHistoryModal = (updateLotHistory) => {
        ...
        // this.addRoughHistoryButtonRef.current.focus();
        if (updateLotHistory) {
            this.getLotHistory(lotId);
    ...
    render() {
        ...
        const roughHistoryRows = roughs && roughs.map(rh => <div>
            <br />
            ...
            <Col>{rh.lot_name}</Col> */}
                ...
                <Col>
                    {!rh.end_date &&
                        <Button onClick={this.openUpdateRoughHistoryModal.bind(this, rh)}>
