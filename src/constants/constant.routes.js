module.exports = {
  routes: {
    ...
    UPDATE_LOT: 'rough/update-lot-data',
    GET_PLAN_DETAIL: 'rough/get-plan-detail',
    GET_LS_DETAIL: 'rough/get-ls-detail',
    ...
    GET_ALL_LOT_LIST: "rough/get-all-lot-list",

    ADD_PERSON: 'person/add-person',
    UPDATE_PERSON: 'person/update-person',
    GET_PERSONS: 'person/get-persons'
  }
}